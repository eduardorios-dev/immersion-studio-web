  ...
  return <>
    ...
    <main id="top">
      <section className="hero dark">
        ...
        <div className="experience" aria-label="Vista conceptual de una experiencia virtual"><div className="xp-top"><span>IMMERSION / DEMO</span><span>01 — 05</span></div><div className="xp-scene"><div className="arch a1"/><div className="arch a2"/><div className="arch a3"/><span className="hotspot h1">+</span><span className="hotspot h2">+</span><span className="room-label">TERRAZA<br/><small>Explorar espacio</small></span></div><div className="xp-bottom"><span>←</span><div><b>Experiencia 360°</b><small>Navega · Descubre · Decide</small></div><span>→</span></div></div>
