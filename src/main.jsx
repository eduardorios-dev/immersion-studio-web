  ...
  return <>
    ...
    <main id="top">
      <section className="hero dark">
        ...
        <figure className="hero-photo"><img src="/hero-recorrido-2026.jpg" alt="Fachada de Quinta Montes Molina capturada para un recorrido virtual 360°"/></figure>
        <a className="scroll" href="#soluciones"><ArrowDown/> Descubre Immersion</a>
      </section>

      <section className="intro section" id="soluciones"><div className="section-label">01 / QUÉ HACEMOS</div><div className="intro-grid"><h2>Experiencias virtuales que transforman la forma de presentar tus espacios.</h2><div className="intro-detail"><div><p className="big-copy">Integramos navegación, fotografía, video, información y contenido multimedia en una sola experiencia digital.</p><p>Cada proyecto se diseña para comunicar mejor el valor de una propiedad y hacer que explorarla sea claro, visual y memorable.</p></div><figure className="intro-photo"><img src="/intro-recorrido.jpg" alt="Habitación Master de Casa Loreto 1893 dentro de un recorrido virtual 360°"/></figure></div></div><div className="service-grid"><article><Camera/><span>01</span><h3>Recorridos 360°</h3><p>Captura panorámica profesional de habitaciones, áreas, amenidades y espacios principales.</p></article><article><Layers3/><span>02</span><h3>Plataformas interactivas</h3><p>Navegación por áreas, hotspots, información, imágenes, video y enlaces en un solo lugar.</p></article><article><Sparkles/><span>03</span><h3>Experiencias personalizadas</h3><p>Diseño, estructura y contenido adaptados a la identidad y necesidades de cada proyecto.</p></article></div></section>

      <section className="steps dark section"><div className="section-label">02 / CÓMO FUNCIONA</div><div className="steps-title"><p>Tus futuros clientes:</p><h2>Exploran.<br/>Conocen.<br/><em>Deciden.</em></h2></div><div className="step-list"><article><b>01</b><div><h3>Exploran</h3><p>Recorren tus espacios libremente, desde cualquier lugar y dispositivo.</p></div></article><article><b>02</b><div><h3>Conocen</h3><p>Descubren áreas, servicios y amenidades dentro de una experiencia clara y visual.</p></div></article><article><b>03</b><div><h3>Deciden</h3><p>Obtienen el contexto necesario para reservar, visitar o avanzar con mayor confianza.</p></div></article></div></section>
      ...
      <section className="commercial dark section"><div className="section-label">07 / USOS COMERCIALES & VR</div><div className="commercial-grid"><div className="commercial-copy"><h2>Una herramienta para presentar, vender y compartir espacios.</h2></div><div className="commercial-side"><div className="use-list">{['Presentaciones comerciales','Ferias y exposiciones','WhatsApp y correo','Sitios web','Showrooms','Realidad virtual'].map((x,i)=><div key={x}><span>{String(i+1).padStart(2,'0')}</span><b>{x}</b><ArrowRight/></div>)}</div><div className="commercial-vr-photo"><img src="/vr-presentacion.jpg" alt="Presentación comercial de una experiencia de realidad virtual"/></div></div></div></section>
