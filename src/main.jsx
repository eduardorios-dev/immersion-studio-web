...
function App(){
  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="commercial dark section"><div className="section-label">07 / USOS COMERCIALES & VR</div><div className="commercial-grid"><div className="commercial-copy"><h2>Una herramienta para presentar, vender y compartir espacios.</h2><div className="vr-visual"><div className="vr-glow"/><img src="/meta-quest.png" alt="Visor de realidad virtual Meta Quest"/></div></div><div className="use-list">{['Presentaciones comerciales','Ferias y exposiciones','WhatsApp y correo','Sitios web','Showrooms','Realidad virtual'].map((x,i)=><div key={x}><span>{String(i+1).padStart(2,'0')}</span><b>{x}</b><ArrowRight/></div>)}</div></div></section>
